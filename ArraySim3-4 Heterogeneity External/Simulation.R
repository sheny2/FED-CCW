# =============================================================
# Simulation.R -- one replicate of the one-shot heterogeneous-site study:
#   external-numerator federated CCW, aligned pooled CCW,
#   TV-IPCW without cloning, and naive per-protocol.
# =============================================================
