...
# This independent reference population is generated once, before any
# simulation replicate is analyzed. The same numerator vector is then reused
# across all sites, heterogeneity levels, treatment effects, and replicates.
EXTERNAL_REFERENCE_FILE <- "external_reference_numerator.rds"
EXTERNAL_REFERENCE_N <- 3e6
EXTERNAL_REFERENCE_TSTAR <- 25L
EXTERNAL_REFERENCE_HETEROGENEITY <- "moderate"
EXTERNAL_REFERENCE_SEED <- 20260806L
