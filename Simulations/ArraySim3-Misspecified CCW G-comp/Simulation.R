# =============================================================
# Simulation.R -- one replicate of the trimmed two-method study:
#   fed-CCW-TVIPCW and CC-gcomp, each in correct / no_tv / coarse_L form.
#   The misspec axis degrades fed-CCW's weight model and g-comp's outcome
#   model in the same cell.
# =============================================================
