#!/usr/bin/env Rscript
# ============================================================================
# ArraySim5-5 G-computation Oracle array-job simulation over the
...
# covariate effects and the outcome model stay fixed. A parametric Monte Carlo
# g-computation oracle is recomputed for every cell using its exact
# target-population site proportions and the true longitudinal DGP.
#
...
# ---- 3. compute the g-computation oracle once per grid cell ------------
truth_shared <- compute_truth_gcomp_tv(
  N          = SIM$truth_N,
  tau        = SIM$tau,
  t_star     = SIM$t_star,
...
message("  oracle = parametric Monte Carlo g-computation; ",
        "g1 follows true initiation before tau and is forced at tau; ",
        "g0 withholds treatment")
