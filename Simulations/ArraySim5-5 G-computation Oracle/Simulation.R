# =============================================================
# ArraySim5-5: one replicate comparing five estimators across five sites with
# combined sample-size, patient-mix, and treatment-practice heterogeneity:
#   common-numerator federated CCW, pooled CCW with site FE/shared slopes,
#   federated IPW without cloning, federated unweighted PP, and
#   federated landmark IPW. Truth is obtained by parametric g-computation.
# =============================================================
...
run_once_tv <- function(K          = length(DEFAULT_SITE_SIZES),
  ...
  fits <- list(
    ...
    pooled_ccw_site_fe = run_pooled_ccw_site_fe(
      dat, tau = tau, t_star = t_star, trunc = trunc
    ),
