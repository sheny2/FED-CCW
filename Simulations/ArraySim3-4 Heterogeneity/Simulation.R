# =============================================================
# Simulation.R -- one replicate of the heterogeneous-site study:
#   federated CCW, pooled CCW, direct g-computation (no cloning),
...
run_once_tv <- function(K          = 3,
  ...
  fits <- list(
    ...
    pooled_ccw_tvipcw = run_pooled_ccw_tvipcw(dat, tau = tau, t_star = t_star,
                                              trunc = trunc),
    direct_gcomp      = run_gcomp_noclone(dat, tau = tau, t_star = t_star,
                                          mc = mc_gcomp,
                                          seed = base_seed + 777),
