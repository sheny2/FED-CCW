# =============================================================
# ArraySim5-4: one replicate comparing six estimators across five sites with
# combined sample-size, patient-mix, and treatment-practice heterogeneity:
#   common-numerator federated CCW, two pooled CCW implementations,
...
run_once_tv <- function(K          = length(DEFAULT_SITE_SIZES),
  ...
  fits <- list(
    ...
    pooled_ccw_site_stratified = run_pooled_ccw_site_stratified(
      dat, tau = tau, t_star = t_star, trunc = trunc
    ),
