#!/usr/bin/env Rscript
# Lightweight preflight for ArraySim5-4 Combined Site Heterogeneity.
...
expected <- c(
  "fed_ccw_tvipcw", "pooled_ccw_site_stratified", "pooled_ccw_site_fe",
...
message("All ArraySim5-4 Combined Site Heterogeneity preflight checks passed.")
