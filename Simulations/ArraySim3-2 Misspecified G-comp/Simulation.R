# =============================================================
# Simulation.R -- one replicate of the time-varying study:
#   fed-CCW-TVIPCW, pooled-CCW-TVIPCW, CC-gcomp, plain g-comp,
#   TVIPCW-no-clone, naive PP.
# =============================================================
...
run_once_tv <- function(K          = 3,
                        ...
                        trunc      = DEFAULT_TRUNC,
                        mc_gcomp   = 20,
                        gcomp_misspec = DEFAULT_GCOMP_MISSPEC,
                        base_seed  = 2024,
                        truth_N    = 2e6,
                        truth_seed = 999,
                        truth      = NULL,
  ...
  fits <- list(
    ...
    ccw_gcomp         = run_ccw_gcomp(dat, tau = tau, t_star = t_star,
                                      ...
                                      misspec = gcomp_misspec),
    gcomp_no_clone    = run_gcomp_noclone(dat, tau = tau, t_star = t_star,
                                          mc = mc_gcomp, seed = base_seed + 777,
                                          misspec = gcomp_misspec),
