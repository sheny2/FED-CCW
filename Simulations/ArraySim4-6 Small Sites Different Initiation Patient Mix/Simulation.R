# =============================================================
# ArraySim4-6: one replicate comparing six estimators across three sites in a
# site-size balance by patient-mix heterogeneity factorial design:
...
run_once_tv <- function(K          = STUDY_K,
