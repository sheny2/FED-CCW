# =============================================================
# ArraySim4-2 Unbalance: one replicate comparing six estimators under unequal
# site sizes and site-specific treatment-initiation prevalence:
...
run_once_tv <- function(K          = 3,
                        n_per_site = UNBALANCED_SITE_SIZES,
