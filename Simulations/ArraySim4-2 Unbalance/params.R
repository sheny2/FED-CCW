# =============================================================
# ArraySim4-2 Unbalance params.R -- single source of truth for DGP parameters.
...
# Site 1 is small and rarely initiates; site 3 is large and initiates often.
# Slopes still vary through DEFAULT_CONF_MULTS, while these intercepts remain
# fixed so every confounding scenario retains the same between-site contrast.
UNBALANCED_SITE_SIZES <- c(`1` = 200L, `2` = 800L, `3` = 2000L)
SITE_INIT_INTERCEPTS <- c(`1` = -4.5, `2` = -3.0, `3` = -1.5)
