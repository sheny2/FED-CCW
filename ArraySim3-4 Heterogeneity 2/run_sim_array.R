#!/usr/bin/env Rscript
# ============================================================================
# Corrected common-numerator array simulation over
...
#
# Federated sites share only interval-level initiation/at-risk counts to
# construct one common numerator. Local conditional denominator models remain
# private. Each SLURM task handles one grid cell and parallelizes replicates.
#
# Usage:
...
# ---- 3. common-numerator aggregated oracle, once per grid cell ----------
...
results$numerator     <- "common_federated_counts"
